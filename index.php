...
<head>
  ...
  <title>kjch导航</title>
  <link rel="stylesheet" href="https://cdn.staticfile.org/font-awesome/4.7.0/css/font-awesome.css"><!--Font-awesome图标库-->
  <link rel="stylesheet" href="fontawesome/css/fontawesome.min.css"><!--Font-awesome本地图标库-->
  ...
  <script src="//at.alicdn.com/t/font_400990_j21lstb4wx.js"></script>  <!--阿里图标库-->
  <script src="./test.js"></script>  <!--阿里图标库 缺少的图标把对应的svg代码加到里面就可以了-->
    ...
    <div class="list closed">
        <ul>
          ...
          <!------>
            ...
            <!------>
            <li class="title"><svg class="icon" aria-hidden="true"><use xlink:href="#icon-tool"></use></svg> 工具</li>
            ...
            <!------>
            <li class="title"><svg class="icon" aria-hidden="true"><use xlink:href="#icon-code"></use></svg> 开发</li>
            ...
            <li><pre><a rel="nofollow" href="https://www.runoob.com/" target="_blank"> <i class="fa fa-code" aria-hidden="true"></i> 菜鸟教程</a></pre></li>
			<!------->
...
<!--天气-->
    ...
    <div id="content">
            ...
            <div class="sou">
                <form action="" method="post" target="_self">
                   ...
                   if ($t=="b"){
                    ...
                    <input class="wd" type="text" placeholder="请输入搜索内容,点击左侧图标可切换搜索引擎!" name="q" x-webkit-speech lang="zh-CN" autocomplete="off">
        ...
        <div class="foot" style="height: 40px;">
          <a href="http://cloud.zhuimyun.cn/" target="_blank" style="color: #777;">佳城互联</a> | 
          <a href="./" style="color: #777;">kjch导航</a> | 
          <a href="https://github.com/1834423612/sou/" target="_blank" style="color: #777;">在Github开源</a><br>
          © 2020-<?php echo date("Y") ?> by <a href="./" color="skyblue">kjch况佳城</a> . All rights reserved.</div>
    </div>
